...
public class Main {
  public static void main(String[] args) {
    ...
    switch (opcao) {
      case 1:
        Padrao fPadrao = new Padrao(matricula, nome, salario);
      ...
      case 2:
        ...
        Comissionado Comissionado = new Comissionado(matricula, nome, salario, porcentagem, vendas);
        JOptionPane.showMessageDialog(null, Comissionado.calcularProventos(), "Detalhes do ingresso", JOptionPane.INFORMATION_MESSAGE);
        break;
      case 3:
        ...
        Produtividade fProdutividade = new Produtividade(matricula, nome, salario, valor, producao);
